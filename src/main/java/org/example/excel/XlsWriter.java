...
public class XlsWriter {
    ...
    public static void writeXlsStatistics(List<Statistics> statisticsList,
        ...
        ((XSSFCellStyle) headerStyle).setFont(headerFont);
        ...
        avgScoreCellHeader.setCellValue("Средний балл");
        ...
        logger.log(Level.FINE, "Excel file writing finished successfully");
    }
}
